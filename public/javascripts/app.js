...
.controller('MainCtrl', [
  '$scope','$http',
  function($scope,$http){
    $scope.test = 'Upvote/Downvote below:';
    $scope.comments = [
    ...
    $scope.downvote = function(comment) {
      return $http.put('/comments/' + comment._id + '/downvote')
        .success(function(data){
          console.log("decrement upvote worked");
          comment.upvotes -= 1;
      });
    };

    $scope.getAll(); // This is executed sequentially, so after we do everything we want to get all.
  }
]);
